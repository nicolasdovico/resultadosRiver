...
class Arbitro extends Model
{
    ...
    /**
     * Get aggregate statistics for the arbitro.
     */
    public function getStatsAttribute(): array
    {
        $raw = \DB::table('estadisticas')
            ->where('arbitro', $this->ar_id)
            ->selectRaw("
                count(*) as pj,
    ...
    /**
     * Get the top 3 scorers in matches officiated by this referee.
     */
    public function getTopScorersAttribute(): array
    {
        return \App\Models\Gol::join('estadisticas', 'goles.gol_fecha', '=', 'estadisticas.fecha')
            ...
            ->where('estadisticas.arbitro', $this->ar_id)
    ...
    /**
     * Get winning and losing streaks for this arbitro.
     */
    ...
    /**
     * Get the last won match with this arbitro.
     */
    ...
    /**
     * Get the last lost match with this arbitro.
     */
    ...
    /**
     * Get goals by period (10 min intervals) with this arbitro.
     */
    ...
    /**
     * Get goals by type with this arbitro.
     */
